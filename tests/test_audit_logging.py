...
def test_register_batch_marks_as_duplicate():
    assert not is_duplicate_batch("realbeds", "QualifiedLead", "meta", "20260526", "001")
    register_batch("realbeds", "QualifiedLead", "meta", "20260526", "001", "req-1")
    assert is_duplicate_batch("realbeds", "QualifiedLead", "meta", "20260526", "001")

def test_different_accounts_same_batch_not_duplicate():
    register_batch("realbeds", "QualifiedLead", "meta", "20260526", "001", "req-1")
    assert not is_duplicate_batch("africanoverlandtours", "QualifiedLead", "meta", "20260526", "001")
